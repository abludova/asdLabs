...
//Стратегия этого поиска состоит в том, чтобы идти вглубь одного поддерева настолько, насколько это возможно
//Реализуем рекурсивно: 1. если узел пустой, то выйти 2. выполнить следующие 3 операции: 
// (N)обработать текущий узел, (L)рекурсивно обойти левое поддерево, (R)рекурсивно обойти правое поддерево
// Прямой обход - NLR   Центрированный - LNR   Обратный - LRN
//Коллизия в сбалансированном дереве log2(N), в вырожденном списке стремится к N/2.
